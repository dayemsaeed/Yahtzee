...
void startNewGame(void) {
	...
	do {
		...
		if (numberOfPlay == 26) {
			/* If all categories were selected, then the game is over */
			isGameOver = TRUE;
		}
...
* Date Last Modified: March 9, 2018                         *
...
* Date Created: March 8, 2018                               *
* Date Last Modified: March 10, 2018                        *
...
* Date Created: March 3, 2018                               *
* Date Last Modified: March 8, 2018                         *
...
void printGoodbye(void)
{
	...
	gotoxy(((SCREEN_BORDER_LOWER_X - SCREEN_BORDER_UPPER_X) / 2) - 8,
		(SCREEN_BORDER_LOWER_Y - SCREEN_BORDER_UPPER_Y) / 2 + 3);
	printf("Made by Dayem Saeed");
	printScreenBorder();
	pressEnter();
	system("cls");
}
